...
const faculties = [
  ...
  { name: "Mrs. Alankrita", title: "Faculty, Design & Surface Ornamentation", img: alankrita, desc: `Mrs. Alankrita is a fashion designer skilled for her exceptional hand‑illustration techniques and innovative embroidery that integrates a wide range of traditional and contemporary methods. Her works shows intricate stitchwork and bold visual narratives,. As a faculty member, she delivers lectures and workshops with enthusiasm, fostering creativity and technical proficiency among students while mentoring them in portfolio development and industry practices.` },
];
