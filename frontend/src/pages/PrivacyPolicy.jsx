  ...
  return (
    <main className="bg-white text-gray-900 font-sans">
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* meta line */}
        <div className="text-sm text-gray-500 mb-6">Last updated: <span className="font-medium text-gray-700">Apr 21, 2021</span></div>
        ...
        <p className="text-sm text-gray-700 leading-relaxed mb-8">
          This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal
          data when You use the Service and tells You about Your privacy rights and how the law protects You.
        </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mt-2">The words with capitalised initials have meanings defined under the following sections of this Privacy Policy.</p>

          <h3 className="font-semibold mt-4">Definitions</h3>
          <p className="text-sm text-gray-700 mt-2">For the purposes of this Privacy Policy:</p>

          <ul className="list-disc list-inside text-sm text-gray-700 mt-3 space-y-2">
            <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NIF Global.</li>
...
<h2 className="text-2xl font-bold mt-10 mb-4">Use of Your Personal Data</h2>
<p className="mb-4">
...
{/* Retention */}
<h2 className="text-2xl font-bold mt-10 mb-4">Retention of Your Personal Data</h2>
<p className="mb-4">
...
{/* Transfer */}
<h2 className="text-2xl font-bold mt-10 mb-4">Transfer of Your Personal Data</h2>
<p className="mb-4">
...
{/* Delete */}
<h2 className="text-2xl font-bold mt-10 mb-4">Delete Your Personal Data</h2>
<p className="mb-4">
...
{/* Disclosure */}
<h2 className="text-2xl font-bold mt-10 mb-4">Disclosure of Your Personal Data</h2>
      ...
      <section>
        ...
        <ul className="list-disc list-inside mt-4 space-y-2">
          <li>
            ...
            <a
              href="https://nifglobalkolkatalindsay.com/contact-us/"
              className="text-blue-600 underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://nifglobalkolkatalindsay.com/contact-us/
            </a>
          </li>
        </ul>
      </section>
