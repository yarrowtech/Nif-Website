...
export default function Terms() {
  return (
    <div className="terms-container px-6 py-12 max-w-4xl mx-auto font-sans text-gray-800">
      <h1 className="text-3xl font-bold mb-6">Terms and Conditions</h1>
      <p className="mb-4">Last updated: April 28, 2025</p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          refers to Nif Global Lindsay, 20A, Lindsay Street, 2nd Floor, Humayan Court, Dharmatala, New Market, Kolkata – 700087.
        </li>
        ...
        <li>
          <strong>Website</strong> refers to Nif Global Kolkata Lindsay, accessible from <a href="https://nifglobalkolkatalindsay.com/" className="text-blue-600 underline">https://nifglobalkolkatalindsay.com/</a>
        </li>
        <li>
      ...
      <p className="mb-4">
        {/* Add content for Severability and Waiver here if needed */}
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>By email: <a href="mailto:niflindsaysocialmarketing@gmail.com" className="text-blue-600 underline">niflindsaysocialmarketing@gmail.com</a></li>
      </ul>
    </div>
  );
}
